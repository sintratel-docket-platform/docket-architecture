...
| 05 | Testing strategy | [`testing-strategy.md`](testing-strategy.md), `AGENTS.md` §9. All five services carry L1 and L2 (259 tests), `docket-gitops/e2e` carries L3, all three gate promotion since card #17 |
